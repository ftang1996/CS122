...
from PA1.hashing_aligner import genome_align
...
def trivial_algorithm(paired_end_reads, ref):
    ...
    for read_pair in paired_end_reads:
        ...
        if count % 10 == 0:
            ...
            print('{} reads aligned' + format(count))
            print('in {:.3} minutes' + format(time_passed))
...
if __name__ == "__main__":
    ...
    # Call my alignment implementation genome_align instead of skeleton function
